...
<body>
    ...
    <section class="container py-5">
        ...
        <!-- <div class="row projects gx-lg-5"> -->
            <!-- <a href="work-single.html" class="col-sm-6 col-lg-4 text-decoration-none project marketing social business"> -->
                <div class="service-work overflow-hidden card mb-5 mx-5 m-sm-0">
                    ...
                    <div class="card-body">
                    <h6 class="h6 text-center col-12 py-5 semi-bold-600">PRIVATE FILES</h6>
        ...
        if(isset($_REQUEST['sub'])){
            ...
            $query="insert into privatefile(filename,description,uploadedfile,username)values('$filename','$description','$name','{$_SESSION['id']}')";
    ...
    <table class="table" border="2px;">
            ...
            $query="select * from privatefile where username='{$_SESSION['id']}'";
            $result=mysqli_query($link,$query);
