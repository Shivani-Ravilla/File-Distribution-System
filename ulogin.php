...
<body>
    ...
    <section class="bg-light w-100">
        <div class="container">
            <div class="row d-flex align-items-center py-5">
                <div class="col-lg-6 text-start">
                    ...
                    <h1 class="h1 py-5 text-primary typo-space-line">USER LOGIN</h1>
                    <!-- <p class="light-300">
                    ...
                    <form name="f" method="post" action="success2.php">
        ...
        <input type="submit" name="sub" class="btn btn-secondary text-white btn-lg rounded-pill rounded-start px-lg-4" value="log in"/>
    </form>
    <?php
    if(isset($_GET['m'])){
            ...
            <div class="row py-4">
                ...
                <div class="col-lg-3 col-12 align-left">
                    <a class="navbar-brand" href="index.html">
                        <i class='text-light h5">Purple</span> <span class="text-light h5 semi-bold-600">Buzz</span>
                    </a>
                    <p class="text-light my-lg-4 my-2">
                        Lorem ipsum dbx bx-buildings bx-sm text-light'></i>
                        <span class="olor sit amet, consectetur adipisicing elit,
