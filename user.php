...
<script lang="javascript">
        function check(){
            // if(isNaN(document.f.roll.value)){
            //     alert("invalid roll no");
            //     return false;
            // }
            // if(document.f.br.value==="Select branch"){
        ...
        //         return false;
        //     }
            if(document.f.m.value.length!==10){
                alert("mobile no is not 10 digit");
                return false;
         }
        return true;
    }
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="navbar-toggler-success">
                <div class="flex-fill mx-xl-5 mb-2">
                    <ul class="nav navbar-nav d-flex justify-content-between mx-xl-5 text-center text-dark">
                        ...
                        <!-- <li class="nav-item">
                            <a class="nav-link btn-outline-primary rounded-pill px-3" href="login.php">admin login</a>
                        </li> -->
                        <!-- <li class="nav-item">
        ...
        <!-- <div class="row projects gx-lg-5"> -->
            <!-- <a href="work-single.html" class="col-sm-6 col-lg-4 text-decoration-none project marketing social business"> -->
                <div class="service-work overflow-hidden card mb-5 mx-5 m-sm-0">
                    ...
                    <div class="card-body">
                    <h2 class="h2 text-center col-12 py-5 semi-bold-600">REGISTRATION</h2>
                    <form name="f" method="post" action="success1.php">
                    <input type="text" name="fn" placeholder="firstname" pattern="[A-Za-z/ /]+" title="only characters" required class="form-control form-control-lg rounded-pill rounded-end"/><br/>
                <input type="text" placeholder="lastname" class="form-control form-control-lg rounded-pill rounded-end" name="ln"/><br/>
                <input type="email" name="e" placeholder="email" class="form-control form-control-lg rounded-pill rounded-end"/><br/>
                <input type="text" placeholder="mobile" pattern="[6,7,8,9][0-9]{9}" title="10 digit mobile no" class="form-control form-control-lg rounded-pill rounded-end" name="m" length='10' /><br/>
                <input type="text area" name="a" placeholder="address" class="form-control form-control-lg rounded-pill rounded-end"/><br/>
                 <input type="text" name="u" placeholder="username" class="form-control form-control-lg rounded-pill rounded-end"/><br/>
                <input type="password" placeholder="password" class="form-control form-control-lg rounded-pill rounded-end" name="p"/><br/>
        <input type="submit" name="sub" class="btn btn-secondary text-white btn-lg rounded-pill rounded-start px-lg-4" value="submit"/>
    </form>
